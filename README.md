...
**Download Model**: Get the `model.pth` file from the following Google Drive link:

👉 [Download Model (.pth)](https://drive.google.com/file/d/1-3wZ7vXqX8qJYxZ4yZ5xZ6qZ7qZ8qZ9q/view)
